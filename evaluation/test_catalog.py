...
def all_tests() -> list[TestCase]:
    tests: list[TestCase] = [
        ...
        file_attack("ATK-F-11", "SQL keyword in monitored text", "WARDS/backend/README.md", "\n1,union select password from admins\n"),
        ...
        context_domain_case("ATK-DB1-01", "citizen_users email tamper signal", "vm1_database", "attack", "vm1_database_integrity", {"database_integrity_deviation": True, "affected_table": "citizen_users", "operation": "update", "method_legitimate": False}),
        context_domain_case("ATK-DB1-02", "admins password_hash tamper signal", "vm1_database", "attack", "vm1_database_integrity", {"database_integrity_deviation": True, "affected_table": "admins", "affected_column": "hashed_password", "operation": "update", "method_legitimate": False}),
        context_domain_case("ATK-DB1-03", "payment amount tamper signal", "vm1_database", "attack", "vm1_database_integrity", {"database_integrity_deviation": True, "affected_table": "payments", "operation": "update", "method_legitimate": False}),
        context_domain_case("ATK-DB1-04", "Unauthorized admin insertion signal", "vm1_database", "attack", "vm1_database_integrity", {"database_integrity_deviation": True, "affected_table": "admins", "operation": "insert", "method_legitimate": False}),
        context_domain_case("ATK-DB1-05", "Unauthorized row deletion signal", "vm1_database", "attack", "vm1_database_integrity", {"database_integrity_deviation": True, "affected_table": "activity_logs", "operation": "delete", "method_legitimate": False}),
        ...
        benign_file("BEN-F-01", "Operational log append", "WARDS/backend/evaluation_logs/benign-01.log", "\nEvaluation timestamp note.\n"),
        benign_file("BEN-F-02", "Runtime cache note", "WARDS/backend/evaluation_logs/benign-02.log", "\nbenign cache note\n"),
        benign_file("BEN-F-03", "Operational log note", "WARDS/backend/evaluation_logs/benign-03.log", "\nBenign operational log note.\n"),
        benign_file("BEN-F-04", "Temporary cache note", "WARDS/backend/evaluation_logs/benign-04.tmp", "\nbenign cache note\n"),
        benign_file("BEN-F-05", "Health-check scratch note", "WARDS/backend/evaluation_logs/benign-05.log", "\neval benign\n"),
        benign_file("BEN-F-06", "Runtime note append", "WARDS/backend/evaluation_logs/benign-06.log", "\nBenign evaluation note.\n"),
        benign_file("BEN-F-07", "Non-sensitive temp edit", "WARDS/frontend/evaluation_logs/benign-07.tmp", "\n"),
        benign_file("BEN-F-08", "Package cache whitespace", "WARDS/frontend/evaluation_logs/benign-08.tmp", "\n"),
        benign_file("BEN-F-09", "Style build log comment", "WARDS/frontend/evaluation_logs/benign-09.log", "\nbenign eval\n"),
        benign_file("BEN-F-10", "Operational note", "WARDS/backend/evaluation_logs/benign-10.log", "\nBenign command note.\n"),
