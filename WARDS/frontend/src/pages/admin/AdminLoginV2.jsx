      ...
      <div className="relative z-10 bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full">
          ...
          <form onSubmit={handleTotpSubmit} className="space-y-6">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-lg font-semibold disabled:opacity-50 shadow-lg"
              >
        ...
        {step === 'setup' && mfaSetupData && (
          <div className="space-y-5">
            ...
            <div className="flex justify-center">
              <img src={mfaSetupData.qr_code} alt="MFA QR code" className="border-4 border-blue-500 rounded-lg" />
            </div>
