...
function EditProfileModal({ open, profile, onClose, onSuccess }) {
  ...
  const handleContactChange = (e) => {
    ...
    setErrors((prev) => ({ ...prev, contact_number: validatePhilippineContactDigits(digits) }));
  };
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <button
          ...
          className="bg-white rounded-xl shadow-md p-5 border border-gray-200 text-left transition hover:shadow-lg"
        >
