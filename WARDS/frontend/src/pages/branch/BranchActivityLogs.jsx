...
const BranchActivityLogs = () => {
  ...
  const fetchLogs = async (nextPage = 1) => {
    ...
    try {
      ...
      // Strip empty strings so backend doesn't get blank filter values
  ...
  return (
    <div className="space-y-6">
      <WardsPageHero
        eyebrow="Branch Admin Dashboard"
        title="Activity Logs"
        subtitle="Monitor activities performed by users within your branch."
      />
      ...
      <section className="rounded-xl bg-white overflow-hidden shadow">
        ...
        {loading ? (
          ...
          <>
            <div className="overflow-x-auto rounded-xl border border-slate-200 md:overflow-hidden">
              <table className="w-full table-auto text-sm min-w-[700px]">
      ...
      {selectedLog && (
        <div className="fixed inset-0 z-[90] flex items-center justify-center bg-slate-950/60 px-4 py-6" role="dialog" aria-modal="true" aria-labelledby="branch-log-modal-title">
          <div className="w-full max-w-xl rounded-[28px] bg-white p-6 shadow-[0_30px_80px_rgba(15,23,42,0.28)] md:p-8">
            <div className="flex items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <h2 id="branch-log-modal-title" className="mt-2 text-2xl font-bold text-slate-900">{selectedLog.title || selectedLog.action}</h2>
