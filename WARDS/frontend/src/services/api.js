...
export const unifiedAuthAPI = {
  ...
  setupMfaAuthenticated: () => api.post('/auth/unified/setup-mfa-authenticated'),
  verifyMfaSetup: (data) => api.post('/auth/unified/verify-mfa-setup', data),
  verifyMfaSetupAuthenticated: (data) => api.post('/auth/unified/verify-mfa-setup-authenticated', data),
