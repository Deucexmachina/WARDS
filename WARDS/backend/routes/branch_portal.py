...
async def list_branch_payments(
    ...
    for payment in payments:
        ...
        serialized.append({
            ...
            "transaction_id": get_decrypted_or_raw(payment, "txn_id") or payment.txn_id,
            ...
            "property_ref_number": get_decrypted_or_raw(payment, "property_ref_number") or payment.property_ref_number,
            ...
            "proof_file_name": get_decrypted_or_raw(payment, "proof_file_name") or payment.proof_file_name,
            "proof_uploaded_at": to_utc_iso(payment.proof_uploaded_at),
            "has_payment_proof": bool(get_decrypted_or_raw(payment, "proof_file_path") or payment.proof_file_path),
            "proof_download_url": f"/api/payments/{payment.id}/proof" if (get_decrypted_or_raw(payment, "proof_file_path") or payment.proof_file_path) else None,
            "metadata": metadata,
            "treasury_remarks": get_decrypted_or_raw(payment, "treasury_remarks") or payment.treasury_remarks,
            "official_receipt_number": get_decrypted_or_raw(payment, "official_receipt_number") or payment.official_receipt_number,
            "official_receipt_download_url": f"/api/payments/{payment.id}/official-receipt" if (get_decrypted_or_raw(payment, "official_receipt_path") or payment.official_receipt_path) else None,
            "bt_application": {
